...
class Status : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var txtView_mat: Array<Array<TextView>> = arrayOf(
            arrayOf(
                findViewById(R.id.tv_producto_n1_1),
                findViewById(R.id.tv_producto_n1_2),
                findViewById(R.id.tv_producto_n1_3)
            ),
            arrayOf(
                findViewById(R.id.tv_producto_n2_1),
                findViewById(R.id.tv_producto_n2_2),
                findViewById(R.id.tv_producto_n2_3)
            ),
            arrayOf(
                findViewById(R.id.tv_producto_n3_1),
                findViewById(R.id.tv_producto_n3_2),
                findViewById(R.id.tv_producto_n3_3)
            ),
            arrayOf(
                findViewById(R.id.tv_producto_n4_1),
                findViewById(R.id.tv_producto_n4_2),
                findViewById(R.id.tv_producto_n4_3)
            ),
            arrayOf(
                findViewById(R.id.tv_producto_n5_1),
                findViewById(R.id.tv_producto_n5_2),
                findViewById(R.id.tv_producto_n5_3)
            ),
            arrayOf(
                findViewById(R.id.tv_producto_n6_1),
                findViewById(R.id.tv_producto_n6_2),
                findViewById(R.id.tv_producto_n6_3)
            )
        )

        var txtView_written_prodducts_arr: Array<TextView> = arrayOf(
            findViewById(R.id.tv_producto_n1_4),
            findViewById(R.id.tv_producto_n2_4),
            findViewById(R.id.tv_producto_n3_4),
            findViewById(R.id.tv_producto_n4_4),
            findViewById(R.id.tv_producto_n5_4),
            findViewById(R.id.tv_producto_n6_4)
        )


        var imgView_mat: Array<Array<ImageView>> = arrayOf(
            arrayOf(
                findViewById(R.id.iv_n1_1),
                findViewById(R.id.iv_n1_2),
                findViewById(R.id.iv_n1_3)
            ),
            arrayOf(
                findViewById(R.id.iv_n2_1),
                findViewById(R.id.iv_n2_2),
                findViewById(R.id.iv_n2_3)
            ),
            arrayOf(
                findViewById(R.id.iv_n3_1),
                findViewById(R.id.iv_n3_2),
                findViewById(R.id.iv_n3_3)
            ),
            arrayOf(
                findViewById(R.id.iv_n4_1),
                findViewById(R.id.iv_n4_2),
                findViewById(R.id.iv_n4_3)
            ),
            arrayOf(
                findViewById(R.id.iv_n5_1),
                findViewById(R.id.iv_n5_2),
                findViewById(R.id.iv_n5_3)
            ),
            arrayOf(
                findViewById(R.id.iv_n6_1),
                findViewById(R.id.iv_n6_2),
                findViewById(R.id.iv_n6_3)
            )
        )
        ...
        var saveData: SaveDataClass =
            SaveDataClass(selected_products_mat, written_products_arr, this)
        ...
        val level1: LevelClass = LevelClass(
            1,
            selected_products_mat[0],
            txtView_mat[0],
            imgView_mat[0],
            written_products_arr[0],
            txtView_written_prodducts_arr[0]
        )
        val level2: LevelClass = LevelClass(
            2,
            selected_products_mat[1],
            txtView_mat[1],
            imgView_mat[1],
            written_products_arr[1],
            txtView_written_prodducts_arr[1]
        )
        val level3: LevelClass = LevelClass(
            3,
            selected_products_mat[2],
            txtView_mat[2],
            imgView_mat[2],
            written_products_arr[2],
            txtView_written_prodducts_arr[2]
        )
        val level4: LevelClass = LevelClass(
            4,
            selected_products_mat[3],
            txtView_mat[3],
            imgView_mat[3],
            written_products_arr[3],
            txtView_written_prodducts_arr[3]
        )
        val level5: LevelClass = LevelClass(
            5,
            selected_products_mat[4],
            txtView_mat[4],
            imgView_mat[4],
            written_products_arr[4],
            txtView_written_prodducts_arr[4]
        )
        val level6: LevelClass = LevelClass(
            6,
            selected_products_mat[5],
            txtView_mat[5],
            imgView_mat[5],
            written_products_arr[5],
            txtView_written_prodducts_arr[5]
        )
        ...
        button_shopping_list_Activity.isEnabled =
            !(selected_products_mat[0][0] == "null" || selected_products_mat[0][0] == "No hay valores aún")
    ...
    //---------------------------------------------
    //Código de backend
    //La funcion readData lee los datos en tiempo real desde RealTime Firebase y los actualiza en los textViews correspondientes a cada elemento
        ...
        val valueEventListener = object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                for (element in dataSnapshot.children) {
                    var textView: String = "tv_kg_n${j}_${i}"
                    var id: Int = resources.getIdentifier(textView, "id", packageName)
                    if (id != 0) {
                        findViewById<TextView>(id).text = "${element.value.toString()} kg"
                    }
                    i+=1
                    if(i>4){
                        i=1
